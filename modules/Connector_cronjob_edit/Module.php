...
class Module extends Module_Abstract implements Module_Interface {
    ...
    public function run() {
        ...
        if ($form->isValid() && array_key_exists('formname', $requests) && $requests['formname'] == 'cronjobedit' && array_key_exists('cronjobid', $requests)) {
        ...
        if ($form->isValid() && array_key_exists('formname', $requests) && $requests['formname'] == 'cronjobdeactivation' && array_key_exists('cronjobid', $requests)) {
        ...
        if ($form->isValid() && array_key_exists('formname', $requests) && $requests['formname'] == 'cronjobactivation' && array_key_exists('cronjobid', $requests)) {
