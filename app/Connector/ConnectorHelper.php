...
class ConnectorHelper
{
    ...
    public function commandWhitelist()
    {
        $commands = [
            ...
            'process_manufacturer' => ['all' => 0, 'vvv' => 1, 'backlog' => 1],
            ...
            'process_media'        => ['all' => 0, 'vvv' => 1, 'backlog' => 1],
            'cleanup'              => ['all' => 0, 'vvv' => 0, 'backlog' => 0],
            'mapping'              => ['all' => 0, 'vvv' => 0, 'backlog' => 0],
            'swcacheclear'         => ['all' => 0, 'vvv' => 0, 'backlog' => 0],
            'swthemecachegenerate' => ['all' => 0, 'vvv' => 0, 'backlog' => 0],
            'swrebuildseoindex'    => ['all' => 0, 'vvv' => 0, 'backlog' => 0],
            'swrebuildsearchindex' => ['all' => 0, 'vvv' => 0, 'backlog' => 0],
